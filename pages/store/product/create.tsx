...
const CreateProduct = () => {
    ...
    const handleSave = () => {
        const { title, description, price, images } = productData;
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-secondary p-4 relative">
            <div className="max-w-lg w-full">
                <div className={'flex items-center justify-between w-full '}>
                    ...
                    <div className="flex  gap-2 items-center mb-4 font-semibold cursor-pointer text-textColor">
                ...
                <div className={'flex items-center justify-center w-full mb-4 py-6'}>
                    <button
                        className="flex items-center justify-center font-semibold gap-2 mt-2 text-primary text-sm bg-[#dfdfdf] p-2 rounded-full w-full">
